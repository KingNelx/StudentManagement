...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO studentLists (firstName, lastName, studentCourse, studentYear, studentMajor, studentAvatar, email, password)
         VALUES ('$firstName', '$lastName', '$studentCourse', '$yearLevel', '$major', '$avatar', '$email', '$encrypted')";
